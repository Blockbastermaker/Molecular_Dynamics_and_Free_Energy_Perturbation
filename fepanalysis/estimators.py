...
class Estimators():
    ...
    def Convergence(df1,df2,Estimator,StepsChunk_Int,ReplicatiesCount_Int,EnergyOutputInterval_Int):
        ...
        if isinstance(df1, pd.DataFrame) and isinstance(df2, pd.DataFrame) :
            ...
            dGs_Lst=[Estimator(df1,df2,int(steps_limit))[1] for steps_limit in range((StepsChunk_Int-2)*ReplicatiesCount_Int,len(df2)+1,StepsChunk_Int*ReplicatiesCount_Int)]
