...
def main():
    ...
    if args.convergence_analysis is not None:
        ...
        convergenc_df = estimators.Convergence(dEs,args.convergence_analysis[0], int(args.convergence_analysis[1]), int(args.convergence_analysis[2]), int(args.convergence_analysis[3]))
        print(convergenc_df)
