...
def main():
    ...
    if args.convergence_analysis is not None:
        ...
        convergenc_df = tools.Convergence(dEs,estimators.Estimators.Zwanzig, int(args.convergence_analysis[1]), int(args.convergence_analysis[2]), int(args.convergence_analysis[3]))
