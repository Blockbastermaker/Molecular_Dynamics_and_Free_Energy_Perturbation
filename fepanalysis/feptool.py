...
def main():
    ...
    if args.estimator =='Zwanzig_Estimator':
        ...
        BAR_df2=estimators.Estimators.Create_df_BAR_MBAR_2(states_dicts,State_A_Energies_df,1000)
        print('BAR2',BAR_df2)
        BAR_df3=estimators.Estimators.Create_df_BAR_MBAR_2(states_dicts,State_A_Energies_df,100)
        print('BAR3',BAR_df3)
        BAR_df4=estimators.Estimators.Create_df_BAR_MBAR_2(states_dicts,State_A_Energies_df,10000)
        BAR_df5=estimators.Estimators.Create_df_BAR_MBAR_2(states_dicts,State_A_Energies_df,2000)
